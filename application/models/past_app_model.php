<?php if(! defined('BASEPATH')) exit('No direct script access allowed');
	...
	*  signup model
	*/
	class Past_app_model extends CI_model
	{
		
	   function past_app($input) 
		{
			$ipJson = json_encode($input);
			//echo $email;die();

			$this->db->select('a.hospital_name,a.hospital_img_url,b.doctor_name,b.doctor_img_url,c.date_time_slot,c.status,d.speciality_name');
